...
Маленькие изменения → маленький коммит
...
**Дальнейшие планы (следующие шаги)**

Добавить подсчёт результатов в тестах + экран результата

Связать лекции и тесты (тест после лекции)

Добавить прогресс: роль/уровень/XP (после стабилизации сценариев)

Подготовка PWA + Capacitor под мобильную сборку
